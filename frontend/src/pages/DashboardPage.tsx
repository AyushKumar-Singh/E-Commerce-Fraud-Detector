...
import { useDashboardStats, useTrends, useRecentFlags, useModelMetrics } from '../hooks/useAPI';
            ...
            <CardContent>
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-bold">{modelMetrics?.metrics?.accuracy || 99.27}%</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-muted-foreground">Precision</span>
                  <span>{modelMetrics?.metrics?.precision || 17.58}%</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-muted-foreground">Recall</span>
                  <span className="text-success font-bold">{modelMetrics?.metrics?.recall || 86.49}%</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-muted-foreground">AUC-ROC</span>
                  <span className="text-primary font-bold">{modelMetrics?.metrics?.auc_roc || 97.14}%</span>
                </div>
              </div>
            </CardContent>
          </Card>
